...
export declare class Model extends EventEmitter {
    ...
    addListener(event: ModelEventName, listener: ModelEventCallback): this;
    /**
     ...
     * client.connect();
     */
    on(event: ModelEventName, listener: ModelEventCallback): this;
    /**
     * [EventEmitter](https://nodejs.org/api/all.html#events_class_eventemitter)
     ...
     * change, and the value of the property after the change.
     */
    once(event: ModelEventName, listener: ModelEventCallback): this;
    prependListener(event: ModelEventName, listener: ModelEventCallback): this;
    prependOnceListener(event: ModelEventName, listener: ModelEventCallback): this;
    /**
     * [EventEmitter](https://nodejs.org/api/all.html#events_class_eventemitter)
     * method that removes a listener callback previously registered with
     * model.on or model.once
     */
    removeListener(event: ModelEventName, listener: ModelEventCallback): this;
    removeAllListeners(event?: ModelEventName): this;
    getMaxListeners(): number;
    setMaxListeners(n: number): this;
    listeners(event: ModelEventName): ModelEventCallback[];
    emit(event: ModelEventName, ...args: Array<UnknownJsonField | string[]>): boolean;
    eventNames(): ModelEventName[];
    listenerCount(type: ModelEventName): number;
    rawListeners(event: ModelEventName): ModelEventCallback[];
    private static readonly eventsForAllModels;
    static addListener: (event: ModelEventName, listener: ModelEventCallback) => EventEmitter;
    /**
     * [EventEmitter](https://nodejs.org/api/all.html#events_class_eventemitter)
     ...
     * client.connect();
     */
    static on: (event: ModelEventName, listener: ModelEventCallback) => EventEmitter;
    /**
     * [EventEmitter](https://nodejs.org/api/all.html#events_class_eventemitter)
     * method like Model.on but the registered callback is only invoked once,
     * on the first instance of the given event
     ...
     * before the change, and the value of the property after the change:
     */
    static once: (event: ModelEventName, listener: ModelEventCallback) => EventEmitter;
    static prependListener: (event: ModelEventName, listener: ModelEventCallback) => EventEmitter;
    static prependOnceListener: (event: ModelEventName, listener: ModelEventCallback) => EventEmitter;
    /**
     * [EventEmitter](https://nodejs.org/api/all.html#events_class_eventemitter)
     * method that removes a listener callback previously registered with
     * Model.on or Model.once
     */
    static removeListener: (event: ModelEventName, listener: ModelEventCallback) => EventEmitter;
    static removeAllListeners: (event?: "sid" | "uid" | "pid" | "lv" | "nm" | "vs" | "msg" | "age" | "avatar" | "blurb" | "camserv" | "chat_bg" | "chat_color" | "chat_font" | "chat_opt" | "city" | "country" | "creation" | "ethnic" | "occupation" | "photos" | "profile" | "camscore" | "continent" | "flags" | "kbit" | "lastnews" | "mg" | "missmfc" | "new_model" | "rank" | "rc" | "topic" | "hidecs" | "sfw" | "model_sw" | "truepvt" | "guests_muted" | "basics_muted" | "share_albums" | "share_follows" | "share_clubs" | "share_collections" | "share_stores" | "share_tm_album" | "tags" | "ANY" | undefined) => EventEmitter;
