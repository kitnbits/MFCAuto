...
class Model extends events_1.EventEmitter {
    ...
    merge(msg) {
        if (typeof msg !== "object") {
            Utils_1.logWithLevel(Utils_1.LogLevel.DEBUG, `[MODEL] merge received an invalid message ${this.uid}`);
            return;
        }
        else {
                        ...
                        if (typeof sites[key2] === "object") {
                            ...
                            for (const key3 in siteObject) {
                                ...
                                if (typeof siteObject[key3] === "string") {
                                    siteObject[key3] = Utils_1.decodeIfNeeded(siteObject[key3]);
                                }
    ...
    getSocialMedia() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                rawContents = yield Utils_1.httpsGet(url);
                ...
                Utils_1.logWithLevel(Utils_1.LogLevel.DEBUG, `[MODEL] getSocialMedia error: ${e} - '${url}'\n\t${rawContents.slice(0, contentsLogLimit)}...`);
                return undefined;
            }
        });
    }
